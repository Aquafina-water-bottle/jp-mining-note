...
<div class="card-description">
  ...
  {{#IsHybridCard}}
    Hybrid ({{#HybridIsSentenceCard}}Sentence{{/HybridIsSentenceCard}}{{^HybridIsSentenceCard}}Word{{/HybridIsSentenceCard}})
  {{/IsHybridCard}}
...
{{#PADoNotShowInfoLegacy}}
  ...
  {{#AltDisplay}}
    {{#IsHybridCard}}
      <div class="expression--hybrid-wrapper">
        <div class="expression expression--single expression--hybrid" id="Display">
          <span class="expression--hybrid-sentence
              {{^HybridIsSentenceCard}}bold-yellow{{/HybridIsSentenceCard}}"
              id="hybrid-sentence">
            {{furigana:AltDisplay}}
          </span>
          <span class="expression--word expression--hybrid-word
              {{#HybridIsSentenceCard}}expression--hybrid-word-white-underline{{/HybridIsSentenceCard}}"
              id="hybrid-word">
            {{Word}}
          </span>
        </div>
...
{{^PADoNotShowInfoLegacy}}
  <div class="expression-box">
    ...
    <script>
      ...
      } else if ("{{IsSentenceCard}}{{HybridIsSentenceCard}}") {
    ...
    {{#AltDisplay}}
      {{#IsHybridCard}}
        <div class="expression expression--hybrid" id="Display">
          <span class="expression--hybrid-sentence
              {{^HybridIsSentenceCard}}bold-yellow{{/HybridIsSentenceCard}}"
              id="hybrid-sentence">
            {{furigana:AltDisplay}}
