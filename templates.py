...
{{#PADoNotShowInfoLegacy}}
    ...
    {{#IsHybridCard}}
      <div class="expression--hybrid-wrapper">
        <div class="expression expression--single expression--hybrid" id="Display">
          <span class="expression--hybrid-sentence bold-yellow" id="hybrid-sentence">{{furigana:AltDisplay}}</span>
          <span class="expression--word expression--hybrid-word bold-yellow" id="hybrid-word">{{Word}}</span>
        </div>
      </div>
    {{/IsHybridCard}}
  ...
  {{^AltDisplay}}
    {{#IsHybridCard}}
      <div class="expression--hybrid-wrapper">
        <div class="expression expression--single expression--hybrid" id="Display">
          <span class="expression--hybrid-sentence bold-yellow" id="hybrid-sentence">｢{{Sentence}}｣</span>
          <span class="expression--word expression--hybrid-word bold-yellow" id="hybrid-word">{{Word}}</span>
        </div>
      </div>
    {{/IsHybridCard}}
    ...
    {{#AltDisplay}}
      {{#IsHybridCard}}
        <div class="expression expression--hybrid" id="Display">
          <span class="expression--hybrid-sentence bold-yellow" id="hybrid-sentence">{{furigana:AltDisplay}}</span>
          <span class="expression--word expression--hybrid-word" id="hybrid-word">{{Word}}</span>
        </div>
      {{/IsHybridCard}}
