...
* want to add a duplicate word? Change the `Key` field to something different and add the card
...
### How to Mokuro
Note: I didn't write these guides at all, I just have it here to spam to anyone who's struggling the
